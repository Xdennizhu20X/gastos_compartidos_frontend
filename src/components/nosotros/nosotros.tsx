      ...
      <div className="bg-black flex flex-col items-center px-4">
        ...
        <div className=" pt-20 sm:grid-cols-1 justify-center pb-10 ">
          <BackgroundGradient className="rounded-[22px] flex flex-col items-center bg-white rounded-3xl md:flex-row md:max-w-4xl p-8 sm:p-10 bg-white dark:bg-zinc-900 shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
            <img
            src="https://i.ibb.co/Yk69JxN/siomara.jpg"
              alt="Siomara"
        ...
        <div className="gap-5">
          <BackgroundGradient className="rounded-[22px] flex flex-col items-center bg-white rounded-3xl md:flex-row md:max-w-4xl p-8 sm:p-10 bg-white dark:bg-zinc-900 shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
            ...
            <div className="flex flex-col justify-between p-6 leading-normal">
              <h5 className="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
                Dennis Leonardo Rodríguez Juela
              </h5>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                <strong className="text-purple-400">¡Hola!</strong> Soy <strong className="text-blue-400">Dennis</strong>, estudiante de Ingeniería en Tecnología de la Información y Comunicación en la Universidad Internacional del Ecuador. Mi objetivo es convertirme en un programador fullStack y especializado en diversas áreas de la programación, ya que siempre estoy buscando aprender cosas nuevas.
                <br />
                Tengo experiencia en el desarrollo de landing pages y sitios web funcionales, utilizando frameworks como Django, Angular y React. Actualmente, estamos trabajando con React en nuestro proyecto, y en el ámbito del backend, he manejado Node.js. Sin embargo, mi meta es seguir aprendiendo y perfeccionando mis habilidades para crecer constantemente como programador.
              </p>
            </div>
            
            <img
              src="https://i.ibb.co/nPLLVYb/Imagen-de-Whats-App-2024-05-12-a-las-22-36-38-13027cae.jpg"
              alt="Dennis"
              className="w-44 rounded-full shadow-lg mb-6 md:mb-0 md:mr-6"
            />
          </BackgroundGradient>
        ...
        <div className=" p-20">
          <BackgroundGradient className="flex flex-co md:flex-row sm:p-10 bg-black rounded-[22px] p-8">
            <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto rounded-lg">
              <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                  ...
                  <p className="text-sm text-gray-300 mt-4 leading-relaxed">No dudes en ponerte en contacto con nosotros si tienes preguntas o dudas sobre nuestra aplicación.</p>
